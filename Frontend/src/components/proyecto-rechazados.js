...
import ProyectoRechazado from '../assets/images/manualdeusuario/proyectos rechazados.png'
    ...
    <>
      ...
      >
        <CButton
          ...
          onClick={() => {
            abrirModalConImagen(ProyectoRechazado)
          }}
        >
          ¿Ayuda?
        </CButton>
                ...
                <CCard
                  ...
                  onClick={() =>
                    navigate(`/ProyectosDetalle/${p.Proy_Id}`, {
                      state: { from: '/components/proyecto-rechazados' },
                    })
                  }
                >
